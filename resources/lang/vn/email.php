  ...
  array(
    ...
    'resetPassword' =>
        array(
            ...
            'text' => '  Bạn nhận được email này vì chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn.',
            'text2' => 'Nếu bạn không yêu cầu đặt lại mật khẩu, bạn không cần thực hiện thêm hành động nào.',
            'button' => 'Đặt lại mật khẩu',
            'expire' => 'Link đặt lại mật khẩu sẽ hết hạn trong :count phút.',
        ),
  'newNotice' =>
  array(
